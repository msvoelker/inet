...
public:
    ...
    virtual DplpmtudState *onProbeTimeout(int unackedProbeSize) = 0;
    virtual DplpmtudState *onPtbReceived(int ptbMtu) = 0;
    virtual DplpmtudState *onPmtuInvalid() = 0;
...
protected:
    ...
    virtual void sendProbe(int probeSize, bool rapidTest=false);
